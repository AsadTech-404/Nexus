...
import { getConnectedUsers, getEntrepreneurs, getInvestor, getUserProfile, profile, searchUsers, updateProfile } from "../controller/user.controller.js";
...
userRoute.get('/investors', authenticate, getInvestor);
